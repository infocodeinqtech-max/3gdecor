...
class CmsDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Projects page (hero + categories + featured items)
        ProjectsPageContent::query()->delete();
        ProjectsPageContent::query()->create([
            'banner_image' => MediaPath::path('pages/projects', 'project-banner.png'),
